 ...
 * @author akarnokd
 */
public class ShakespearePlaysScrabbleWithFolyamParallelOpt extends ShakespearePlaysScrabble {
...
//        System.out.println(finalList2);
    ...
    public static void main(String[] args) throws Throwable {
        ShakespearePlaysScrabbleWithFolyamParallelOpt s = new ShakespearePlaysScrabbleWithFolyamParallelOpt();
        s.init();
