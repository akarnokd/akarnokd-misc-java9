...
public class ShakespearePlaysScrabbleWithFlowOpt extends ShakespearePlaysScrabblePerfBase {
...
//        System.out.println(finalList2);
    ...
    public static void main(String[] args) throws Exception {
        ...
        benchmark("ShakespearePlaysScrabbleWithFlowOpt", () -> {
        ...
        System.out.println(bench());
        benchmark("ShakespearePlaysScrabbleWithFlowOpt-Async", () -> {
        ...
        */
        ...
        System.out.println(bench());
        benchmark("ShakespearePlaysScrabbleWithFlowOpt-Actor", () -> {
